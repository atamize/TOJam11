...
public class MasterAudioManager : EditorWindow {
    ...
    private static void ResetPrefs() {
        ...
        MasterAudioSettings.Instance.ShowGizmos = true;
        MasterAudioSettings.Instance.StopZeroVolumeBuses = false;
        MasterAudioSettings.Instance.StopZeroVolumeGroups = false;
        MasterAudioSettings.Instance.StopZeroVolumePlaylists = false;
        MasterAudioSettings.Instance.StopZeroVolumeVariations = false;
        MasterAudioSettings.Instance.ResourceClipsPauseDoNotUnload = false;
        MasterAudioSettings.Instance.ResourceClipsAllLoadAsync = true;

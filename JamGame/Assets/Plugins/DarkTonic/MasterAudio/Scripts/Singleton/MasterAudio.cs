...
#pragma warning disable 1591
        ...
        private void Awake() {
            ...
            for (var i = 0; i < allVars.Count; i++) {
                var aVar = allVars[i];
                aVar.Initialize();
                aVar.VariationUpdater.Initialize();
            }
        ...
        public bool ShowGizmos {
            get {
                return MasterAudioSettings.Instance.ShowGizmos;
            }
            set {
                MasterAudioSettings.Instance.ShowGizmos = value;
        ...
        public bool StopZeroVolumeVariations {
            get {
                return MasterAudioSettings.Instance.StopZeroVolumeVariations;
            }
            set {
                MasterAudioSettings.Instance.StopZeroVolumeVariations = value;
                EditorUtility.SetDirty(MasterAudioSettings.Instance);
            }
        }
        ...
        public bool StopZeroVolumeBuses {
            get {
                return MasterAudioSettings.Instance.StopZeroVolumeBuses;
            }
            set {
                MasterAudioSettings.Instance.StopZeroVolumeBuses = value;
                EditorUtility.SetDirty(MasterAudioSettings.Instance);
            }
        }
        ...
        public bool StopZeroVolumeGroups {
            get {
                return MasterAudioSettings.Instance.StopZeroVolumeGroups;
            }
            set {
                MasterAudioSettings.Instance.StopZeroVolumeGroups = value;
                EditorUtility.SetDirty(MasterAudioSettings.Instance);
            }
        }
        ...
        public bool StopZeroVolumePlaylists {
            get {
                return MasterAudioSettings.Instance.StopZeroVolumePlaylists;
            }
            set {
                MasterAudioSettings.Instance.StopZeroVolumePlaylists = value;
                EditorUtility.SetDirty(MasterAudioSettings.Instance);
            }
        }
        ...
        public bool ResourceClipsAllLoadAsync {
            get {
                return MasterAudioSettings.Instance.ResourceClipsAllLoadAsync;
            }
            set {
                MasterAudioSettings.Instance.ResourceClipsAllLoadAsync = value;
                EditorUtility.SetDirty(MasterAudioSettings.Instance);
            }
        }
        ...
        public bool ResourceClipsPauseDoNotUnload {
            get {
                return MasterAudioSettings.Instance.ResourceClipsPauseDoNotUnload;
            }
            set {
                MasterAudioSettings.Instance.ResourceClipsPauseDoNotUnload = value;
                EditorUtility.SetDirty(MasterAudioSettings.Instance);
            }
        }
#endif
